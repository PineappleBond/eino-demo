...
const (
	ConversationModeAskBeforeEdits    ConversationMode = "ask_before_edits"
	ConversationModeBypassPermissions ConversationMode = "bypass_permissions"
	ConversationModeEditAutomatically ConversationMode = "edit_automatically"
	ConversationModePlanMode          ConversationMode = "plan_mode"
)

// Valid indicates whether the value is a known member of the ConversationMode enum.
func (e ConversationMode) Valid() bool {
	switch e {
	case ConversationModeAskBeforeEdits:
		return true
	case ConversationModeBypassPermissions:
		return true
	case ConversationModeEditAutomatically:
		return true
	case ConversationModePlanMode:
		return true
	default:
		return false
	}
...
// Defines values for PatchConversationsIdJSONBodyMode.
const (
	PatchConversationsIdJSONBodyModeAskBeforeEdits    PatchConversationsIdJSONBodyMode = "ask_before_edits"
	PatchConversationsIdJSONBodyModeBypassPermissions PatchConversationsIdJSONBodyMode = "bypass_permissions"
	PatchConversationsIdJSONBodyModeEditAutomatically PatchConversationsIdJSONBodyMode = "edit_automatically"
	PatchConversationsIdJSONBodyModePlanMode          PatchConversationsIdJSONBodyMode = "plan_mode"
)

// Valid indicates whether the value is a known member of the PatchConversationsIdJSONBodyMode enum.
func (e PatchConversationsIdJSONBodyMode) Valid() bool {
	switch e {
	case PatchConversationsIdJSONBodyModeAskBeforeEdits:
		return true
	case PatchConversationsIdJSONBodyModeBypassPermissions:
		return true
	case PatchConversationsIdJSONBodyModeEditAutomatically:
		return true
	case PatchConversationsIdJSONBodyModePlanMode:
		return true
	default:
		return false
	}
...
// Defines values for PostProjectsIdConversationsJSONBodyMode.
const (
	AskBeforeEdits    PostProjectsIdConversationsJSONBodyMode = "ask_before_edits"
	BypassPermissions PostProjectsIdConversationsJSONBodyMode = "bypass_permissions"
	EditAutomatically PostProjectsIdConversationsJSONBodyMode = "edit_automatically"
	PlanMode          PostProjectsIdConversationsJSONBodyMode = "plan_mode"
)

// Valid indicates whether the value is a known member of the PostProjectsIdConversationsJSONBodyMode enum.
func (e PostProjectsIdConversationsJSONBodyMode) Valid() bool {
	switch e {
	case AskBeforeEdits:
		return true
...
type ConversationUpdatedPayload struct {
	...
	// Mode Conversation permission mode.
...
type PatchConversationsIdJSONBody struct {
	Mode *PatchConversationsIdJSONBodyMode `json:"mode,omitempty"`

	// Title New conversation title
	Title *string `json:"title,omitempty"`
}

// PatchConversationsIdJSONBodyMode defines parameters for PatchConversationsId.
type PatchConversationsIdJSONBodyMode string
